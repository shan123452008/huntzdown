<%-- 
    Document   : bikePost
    Created on : 4 Apr, 2014, 1:14:26 PM
    Author     : shan
--%>
...
<div class="container"><section id="content"><form:form method="post" action="bikesAddPost.do" modelAttribute="bikes" enctype="multipart/form-data">
	<table>
		<tr>
			<td></td>
		...
		<h1>Bike Post Form</h1>
		<tr>
			<td>Bike Name</td>
			<td><input type="text" placeholder="Bike Name" name="bikeName" id="bikeName"/></td>
		</tr>
		<tr>
			<td>Company Name</td>
