		...
		<div id="main">
        	...
        	<div id="portfolio-content" class="cf">        	
				  ...
				  <div id="project-box" class="cf">
                                  Company Name-
                                  <select class="current-menu-item" id="brandName" name="brandName">
				  ...
				  <option value="Apple">Apple</option>
                                  ...
                                  <select class="current-menu-item" id="brandName" name="brandName">
				  <option value="">Select</option>
				  <option value="Apple">Rs 2000 & Below</option>
                                   ...
                                   <input type="button" id="search" value="search" onclick="company();">
                                </div>
